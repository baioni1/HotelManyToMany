...
namespace HotelManyToManyMVC.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoomId,Price,MaxCapacity")] Rooms rooms)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RoomId,Price,MaxCapacity")] Rooms rooms)
        {
            if (ModelState.IsValid)
            {
